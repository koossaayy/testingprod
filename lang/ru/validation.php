...
return [
    ...
    */
    ...
    'base64' => 'Поле :attribute должно содержать действительную строку Base64.',
    ...
    'json' => 'Поле :attribute должно содержать допустимую JSON-строку.',
    ...
    */
    ...
    'attributes' => [
        ...
        'phone' => 'Телефон',
        'send_payment_reminders' => 'Отправлять напоминания об оплате',
        'status' => 'Статус',
