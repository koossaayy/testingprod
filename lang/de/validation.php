...
return [
    ...
    */
    ...
    'ascii' => 'Das Feld :attribute darf nur alphanumerische Single-Byte-Zeichen und Symbole enthalten.',
    ...
    'password' => [
        ...
        'numbers' => 'Das Feld :attribute muss mindestens eine Nummer enthalten.',
    ...
    'prohibited_unless' => 'Das Feld :attribute ist nicht zulässig, außer wenn :other in :values enthalten ist.',
    'prohibits' => 'Das Feld :attribute schließt aus, dass :other vorhanden ist.',
    ...
    */
    ...
    'attributes' => [
        ...
        'currency' => 'Währung',
        'default_payment_terms_days' => 'Standardzahlungsziel in Tagen',
        ...
        'phone' => 'Telefon',
        'send_payment_reminders' => 'Zahlungserinnerungen senden',
        'status' => 'Status',
        'tax_rate' => 'Steuersatz',
    ],
];
